...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-caprasimo text-xl leading-none text-card-foreground",
        className,
      )}
      {...props}
    />
