...
type IconReduxProps = React.ComponentPropsWithoutRef<"svg"> & {
  /**
...
const defaultColor = "#764ABC";

const IconRedux: IconType = React.forwardRef<SVGSVGElement, IconReduxProps>(
  function IconRedux(
    { title = "Redux", color = "currentColor", size = 24, ...others },
    ref,
  ) {
    if (color === "default") {
      color = defaultColor;
...
export { IconRedux as default, defaultColor };
