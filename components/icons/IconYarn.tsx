...
type IconYarnProps = React.ComponentPropsWithoutRef<"svg"> & {
  /**
...
const defaultColor = "#2C8EBB";

const IconYarn: IconType = React.forwardRef<SVGSVGElement, IconYarnProps>(
  function IconYarn(
    { title = "Yarn", color = "currentColor", size = 24, ...others },
    ref,
  ) {
    if (color === "default") {
      color = defaultColor;
...
export { IconYarn as default, defaultColor };
