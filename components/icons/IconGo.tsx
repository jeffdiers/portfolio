...
type IconGoProps = React.ComponentPropsWithoutRef<"svg"> & {
  /**
...
const defaultColor = "#00ADD8";

const IconGo: IconType = React.forwardRef<SVGSVGElement, IconGoProps>(
  function IconGo(
    { title = "Go", color = "currentColor", size = 24, ...others },
    ref,
  ) {
    if (color === "default") {
      color = defaultColor;
...
export { IconGo as default, defaultColor };
